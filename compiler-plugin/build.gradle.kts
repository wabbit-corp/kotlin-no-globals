...
// managed-integrity-v1: 7neTVuFQnUJ
//
...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-no-globals-plugin", project.version.toString())
...
kover {
    ...
    //             // title.set("kotlin-no-globals-plugin Code Coverage") // Uncomment to customize title
    //         }
    //         xml {
...
plugins.withId("org.jetbrains.dokka") {
    afterEvaluate {
        extensions.findByType(DokkaExtension::class)?.apply {
            moduleName.set("kotlin-no-globals-plugin")
            ...
            dokkaSourceSets.named("main").configure {
                ...
                sourceLink {
                    ...
                    remoteUrl("https://github.com/wabbit-corp/kotlin-no-globals/tree/master/compiler-plugin/src/main/kotlin")
