...
// managed-integrity-v1: GA7qDTXknNB
//
...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-no-globals", project.version.toString())
...
publishing {
    publications.withType<org.gradle.api.publish.maven.MavenPublication>().configureEach {
        val configuredArtifactId = "kotlin-no-globals"
...
plugins.withId("org.jetbrains.dokka") {
    afterEvaluate {
        extensions.findByType(DokkaExtension::class)?.apply {
            moduleName.set("kotlin-no-globals")
            ...
            dokkaSourceSets.configureEach {
                ...
                sourceLink {
                    ...
                    remoteUrl("https://github.com/wabbit-corp/kotlin-no-globals/tree/master/library/src")
